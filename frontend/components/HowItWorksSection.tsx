...
const steps = [
  {
    ...
    description: 'Drag and drop your PDF, DOCX, or TXT file. Our system accepts study notes, textbooks, articles, and more.',
  },
  {
    number: '02',
    icon: Sparkles,
    title: 'AI Generates Questions',
    description: 'Our AI analyzes your content and creates relevant multiple-choice questions, with explanations for each answer.',
  },
  {
    number: '03',
    icon: CheckCircle,
    title: 'Practice & Improve',
    description: 'Take practice tests, review your answers, and track your progress. Master any subject with personalized learning.',
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-white/70 max-w-2xl mx-auto">
            Three simple steps to transform your study materials into interactive practice tests.
          </p>
        </div>
